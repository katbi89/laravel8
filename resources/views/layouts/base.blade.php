...
<body class="home-page home-01 ">
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src="{{ asset('assets/images/logo-top-1.png') }}" style="border-radius:27px; margin-left:25px" width="100" alt="mercado"></a>
						</div>
	...
	<script src="https://cdn.tiny.cloud/1/v27czz2gw2kmpyhz5qdaiz5xx4q7wd7tpkv5ptyubzpz37tg/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
	@stack('scripts')
</body>
</html>